// ── ICONS ──
// Extraído de frontend/index.html (líneas ~458-499, sección
// "/* ── ICONS ── */" del <script> monolítico). Contenido idéntico al
...
export const SVG = (paths, size = 20, cls = '') => h('svg', {
...
export const Icons = {
  ...
  undo:`<path d="M3 7v6h6"/><path d="M21 17a9 9 0 00-9-9 9 9 0 00-6.36 2.64L3 13"/>`,
