-- NOTA (Jorge, actualizado 2026-09-14): este archivo hace COMMENT ON
-- COLUMN sobre proveedores_ordenes.cita_id/numero_orden_compra y crea
-- un índice sobre cita_id -- drift detectado el 2026-09-14 (ver
-- 00000000000000_LEAME_metodologia_y_hallazgos.sql sección 2b). YA
-- RESUELTO: 20260804100000_schema_tablas_huerfanas_drift.sql (fecha
-- anterior a este archivo, aprobado por Alejandro) agrega ambas
-- columnas antes de que este script corra -- no hace falta ninguna
-- acción manual. En producción real este archivo sigue siendo no-op
-- seguro (la columna ya existía ahí desde antes).
-- ================================================================
