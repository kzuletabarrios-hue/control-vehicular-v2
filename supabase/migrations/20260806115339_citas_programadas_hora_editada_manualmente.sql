-- NOTA (Jorge, actualizado 2026-09-14): este archivo hace ALTER TABLE
-- sobre citas_programadas -- drift detectado el 2026-09-14 (ver
...
-- anterior a este archivo, aprobado por Alejandro) crea la tabla antes
-- de que este script corra -- no hace falta ninguna acción manual. En
-- producción real este archivo sigue siendo no-op seguro (la tabla ya
-- existía ahí desde antes).
-- ================================================================
