...
-- CONSTRAINT/TABLE/COLUMN/INDEX sobre citas_programadas, configuracion,
-- proveedores.origen e idx_proveedores_ordenes_cita_id -- drift
-- detectado el 2026-09-14 (ver
-- 00000000000000_LEAME_metodologia_y_hallazgos.sql sección 2a; los dos
-- últimos se sumaron el mismo día tras el hallazgo de María corriendo
-- las 46 migraciones contra una base vacía real). YA RESUELTO:
-- 20260804100000_schema_tablas_huerfanas_drift.sql (fecha anterior a
-- este archivo, aprobado por Alejandro) crea los 4 objetos antes de
-- que este script corra -- no hace falta ninguna acción manual. En
-- producción real este archivo sigue siendo no-op seguro (los objetos
-- ya existían ahí desde antes).
-- ================================================================
