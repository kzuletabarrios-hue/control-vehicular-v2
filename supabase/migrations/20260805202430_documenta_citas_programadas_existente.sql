...
-- TABLE/COLUMN sobre citas_programadas y archivos_citas -- drift
-- detectado el 2026-09-14 (ver
-- 00000000000000_LEAME_metodologia_y_hallazgos.sql sección 2a). YA
-- RESUELTO: 20260804100000_schema_tablas_huerfanas_drift.sql (fecha
-- anterior a este archivo, aprobado por Alejandro) crea ambas tablas
-- antes de que este script corra -- no hace falta ninguna acción
-- manual. En producción real este archivo sigue siendo no-op seguro
-- (las tablas ya existían ahí desde antes).
-- ================================================================
